...
# Parsing + Configuration Script – TABS - Rev. A

This **Parsing + Configuration** script is designed for the **TABS** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – TABS Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **TABS** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
